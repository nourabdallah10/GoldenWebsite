...
const Sofas = () => {
  ...
  // Products data
  const [products] = useState<Product[]>(getProductsByCategory('sofas'))
  ...
  return (
    <>
      <SEO
        title="Sofas - Golden Furniture"
        description="Browse our premium collection of sofas. Modern, classic, and designer sofas available. Free delivery in Tel Aviv."
        keywords="sofas, couches, living room furniture, Tel Aviv"
      />
      <motion.div
      ...
      <section className="relative h-[500px] md:h-[600px] lg:h-[700px] overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            backgroundImage: "url('/Images/SofaBackground.jpg')",
          }}
          initial={{ scale: 1.1 }}
          animate={{ scale: 1 }}
              ...
              >
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight">
                  ...
                  <span className="text-amber-400 text-4xl md:text-5xl lg:text-6xl font-light">
                    {language === 'he' ? 'איכות ונוחות' : 'Quality & Comfort'}
                  </span>
                </h1>
                ...
                >
                  {language === 'he'
                    ? 'גלה את אוסף הספות היוקרתי שלנו, מעוצב במיוחד עבור הבית שלך'
                    : 'Discover our premium sofa collection, designed for your home'}
                </motion.p>
