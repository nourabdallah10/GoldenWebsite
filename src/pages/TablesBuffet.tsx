...
const TablesBuffet = () => {
  ...
  // Products data
  const [products] = useState<Product[]>(getProductsByCategory('tables-buffet'))
  ...
  return (
    <>
      <SEO
        title="Tables & Sideboards - Golden Furniture"
        description="Browse our premium collection of tables and sideboards. Modern, classic, and designer furniture available. Free delivery in Tel Aviv."
        keywords="tables, sideboards, buffet, dining furniture, Tel Aviv"
      />
      <motion.div
      ...
      <section className="relative h-[500px] md:h-[600px] lg:h-[700px] overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            backgroundImage: "url('/Images/buffetBackground.jpg')",
          }}
          initial={{ scale: 1.1 }}
          animate={{ scale: 1 }}
              ...
              >
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight">
                  ...
                  <span className="text-amber-400 text-4xl md:text-5xl lg:text-6xl font-light">
                    {language === 'he' ? 'איכות ועיצוב' : 'Quality & Design'}
                  </span>
                </h1>
                ...
                >
                  {language === 'he'
                    ? 'גלה את אוסף השולחנות והמזנונים היוקרתי שלנו, מעוצב במיוחד עבור הבית שלך'
                    : 'Discover our premium tables and sideboards collection, designed for your home'}
                </motion.p>
