...
const Tables = () => {
  ...
  const [products] = useState<Product[]>(getProductsByCategory('tables'))
  ...
  return (
    <>
      <SEO
        title="Tables - Golden Furniture"
        description="Premium table collection. Dining tables, coffee tables, and designer tables. Free delivery in Tel Aviv."
        keywords="tables, dining tables, coffee tables, Tel Aviv"
      />
      <motion.div
      ...
      <section className="relative h-[500px] md:h-[600px] lg:h-[700px] overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            backgroundImage: "url('/Images/TableBackground.jpg')",
          }}
          initial={{ scale: 1.1 }}
          animate={{ scale: 1 }}
              ...
              >
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight">
                  ...
                  <span className="text-amber-400 text-4xl md:text-5xl lg:text-6xl font-light">
                    {language === 'he' ? 'אלגנטיות וסגנון' : 'Elegance & Style'}
                  </span>
                </h1>
                ...
                >
                  {language === 'he'
                    ? 'גלה את אוסף השולחנות היוקרתי שלנו, מעוצב לאלגנטיות וסגנון מושלמים'
                    : 'Discover our premium table collection, designed for elegance and style'}
                </motion.p>
